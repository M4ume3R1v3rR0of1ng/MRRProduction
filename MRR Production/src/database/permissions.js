...
export const PERM_GROUPS = [
  ...
  ['🚛 Fleet', ['fleet_view', 'fleet_edit', 'fleet_log_service', 'fleet_photo_delete', 'fleet_log_mi']],
...
export const DEFAULT_ROLE_PERMS = {
  warehouse: { inv_view: true, inv_edit: true, inv_receive: true, inv_bulk_receive: true, inv_pricing_view: true, inv_pricing_edit: false, inv_adjust: false, fleet_view: true, fleet_edit: true, fleet_log_service: true, fleet_photo_delete: false, fleet_log_mi: true, maint_submit: true, maint_manage: true, jobs_view: true, jobs_build: false, jobs_approve: false, jobs_pull: true, jobs_edit_pull: false, jobs_complete: true, jobs_close: false, reports_view: true, users_manage: false, settings_manage: false },
  coordinator: { inv_view: true, inv_edit: true, inv_receive: true, inv_bulk_receive: true, inv_pricing_view: true, inv_pricing_edit: true, inv_adjust: false, fleet_view: true, fleet_edit: true, fleet_log_service: true, fleet_photo_delete: false, fleet_log_mi: true, maint_submit: true, maint_manage: true, jobs_view: true, jobs_build: true, jobs_approve: true, jobs_pull: true, jobs_edit_pull: true, jobs_complete: true, jobs_close: true, reports_view: true, users_manage: false, settings_manage: false },
  manager: { inv_view: true, inv_edit: true, inv_receive: true, inv_bulk_receive: true, inv_pricing_view: true, inv_pricing_edit: true, inv_adjust: true, fleet_view: true, fleet_edit: false, fleet_log_service: true, fleet_photo_delete: true, fleet_log_mi: false, maint_submit: true, maint_manage: false, jobs_view: true, jobs_build: true, jobs_approve: true, jobs_pull: true, jobs_edit_pull: true, jobs_complete: true, jobs_close: true, reports_view: true, users_manage: false, settings_manage: false },
  employee: { inv_view: false, inv_edit: false, inv_receive: false, inv_bulk_receive: false, inv_pricing_view: false, inv_pricing_edit: false, inv_adjust: false, fleet_view: true, fleet_edit: false, fleet_log_service: true, fleet_photo_delete: false, fleet_log_mi: false, maint_submit: true, maint_manage: false, jobs_view: false, jobs_build: false, jobs_approve: false, jobs_pull: false, jobs_edit_pull: false, jobs_complete: false, jobs_close: false, reports_view: false, users_manage: false, settings_manage: false },
  field: { inv_view: true, inv_edit: true, inv_receive: true, inv_bulk_receive: false, inv_pricing_view: false, inv_pricing_edit: false, inv_adjust: true, fleet_view: true, fleet_edit: false, fleet_log_service: true, fleet_photo_delete: false, fleet_log_mi: true, maint_submit: true, maint_manage: false, jobs_view: true, jobs_build: false, jobs_approve: false, jobs_pull: true, jobs_edit_pull: true, jobs_complete: true, jobs_close: false, reports_view: false, users_manage: false, settings_manage: false },
  bookkeeper: { inv_view: false, inv_edit: false, inv_receive: false, inv_bulk_receive: false, inv_pricing_view: true, inv_pricing_edit: false, inv_adjust: false, fleet_view: false, fleet_edit: false, fleet_log_service: false, fleet_photo_delete: false, fleet_log_mi: false, maint_submit: true, maint_manage: false, jobs_view: true, jobs_build: false, jobs_approve: false, jobs_pull: false, jobs_edit_pull: false, jobs_complete: false, jobs_close: true, reports_view: true, users_manage: false, settings_manage: false },
};
