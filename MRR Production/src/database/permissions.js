...
export const PERM_DEFS = {
  ...
  inv_count: { label: 'Monthly Count', desc: 'Run physical stock counts & see the bleed rate (needs View Inventory)', g: '📦 Inventory' },
  ...
  fleet_log_service: { label: 'Log Service', desc: 'Record completed service work on vehicles', g: '🚛 Fleet' },
  fleet_log_inspection: { label: 'Log Inspections', desc: 'File formal vehicle condition inspection reports', g: '🚛 Fleet' },
  ...
  jobs_revenue: { label: 'View & Set Contract Value', desc: 'See what a job sold for, and job profitability', g: '🏗️ Jobs' },
...
export const PERM_GROUPS = [
  ['📦 Inventory', ['inv_view', 'inv_edit', 'inv_receive', 'inv_bulk_receive', 'inv_pricing_view', 'inv_pricing_edit', 'inv_adjust', 'inv_count']],
  ['🚛 Fleet', ['fleet_view', 'fleet_edit', 'fleet_log_service', 'fleet_log_inspection', 'fleet_photo_delete', 'fleet_log_mi']],
  ['🔧 Maintenance', ['maint_submit', 'maint_manage']],
  ['🏗️ Jobs', ['jobs_view', 'jobs_build', 'jobs_approve', 'jobs_pull', 'jobs_edit_pull', 'jobs_complete', 'jobs_close', 'jobs_revenue']],
...
export const DEFAULT_ROLE_PERMS = {
  warehouse: { inv_view: true, inv_edit: true, inv_receive: true, inv_bulk_receive: true, inv_pricing_view: true, inv_pricing_edit: false, inv_adjust: false, inv_count: true, fleet_view: true, fleet_edit: true, fleet_log_service: true, fleet_log_inspection: true, fleet_photo_delete: false, fleet_log_mi: true, maint_submit: true, maint_manage: true, jobs_view: true, jobs_build: false, jobs_approve: false, jobs_pull: true, jobs_edit_pull: false, jobs_complete: true, jobs_close: false, jobs_revenue: false, reports_view: true, users_manage: false, settings_manage: false },
  coordinator: { inv_view: true, inv_edit: true, inv_receive: true, inv_bulk_receive: true, inv_pricing_view: true, inv_pricing_edit: true, inv_adjust: false, inv_count: false, fleet_view: true, fleet_edit: true, fleet_log_service: true, fleet_log_inspection: true, fleet_photo_delete: false, fleet_log_mi: true, maint_submit: true, maint_manage: true, jobs_view: true, jobs_build: true, jobs_approve: true, jobs_pull: true, jobs_edit_pull: true, jobs_complete: true, jobs_close: true, jobs_revenue: true, reports_view: true, users_manage: false, settings_manage: false },
  manager: { inv_view: true, inv_edit: true, inv_receive: true, inv_bulk_receive: true, inv_pricing_view: true, inv_pricing_edit: true, inv_adjust: true, inv_count: false, fleet_view: true, fleet_edit: false, fleet_log_service: true, fleet_log_inspection: true, fleet_photo_delete: true, fleet_log_mi: false, maint_submit: true, maint_manage: false, jobs_view: true, jobs_build: true, jobs_approve: true, jobs_pull: true, jobs_edit_pull: true, jobs_complete: true, jobs_close: true, jobs_revenue: true, reports_view: true, users_manage: false, settings_manage: false },
  employee: { inv_view: false, inv_edit: false, inv_receive: false, inv_bulk_receive: false, inv_pricing_view: false, inv_pricing_edit: false, inv_adjust: false, inv_count: false, fleet_view: true, fleet_edit: false, fleet_log_service: true, fleet_log_inspection: false, fleet_photo_delete: false, fleet_log_mi: false, maint_submit: true, maint_manage: false, jobs_view: false, jobs_build: false, jobs_approve: false, jobs_pull: false, jobs_edit_pull: false, jobs_complete: false, jobs_close: false, jobs_revenue: false, reports_view: false, users_manage: false, settings_manage: false },
  field: { inv_view: true, inv_edit: true, inv_receive: true, inv_bulk_receive: false, inv_pricing_view: false, inv_pricing_edit: false, inv_adjust: true, inv_count: false, fleet_view: true, fleet_edit: false, fleet_log_service: true, fleet_log_inspection: false, fleet_photo_delete: false, fleet_log_mi: true, maint_submit: true, maint_manage: false, jobs_view: true, jobs_build: false, jobs_approve: false, jobs_pull: true, jobs_edit_pull: true, jobs_complete: true, jobs_close: false, jobs_revenue: false, reports_view: false, users_manage: false, settings_manage: false },
  bookkeeper: { inv_view: false, inv_edit: false, inv_receive: false, inv_bulk_receive: false, inv_pricing_view: true, inv_pricing_edit: false, inv_adjust: false, inv_count: false, fleet_view: false, fleet_edit: false, fleet_log_service: false, fleet_log_inspection: false, fleet_photo_delete: false, fleet_log_mi: false, maint_submit: true, maint_manage: false, jobs_view: true, jobs_build: false, jobs_approve: false, jobs_pull: false, jobs_edit_pull: false, jobs_complete: false, jobs_close: true, jobs_revenue: true, reports_view: true, users_manage: false, settings_manage: false },
};
