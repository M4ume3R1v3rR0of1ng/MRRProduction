...
export const translations = {
  en: {
    ...
    stUploadReport: "Upload report to AccuLynx",
    stUploadReportDesc: "File the report PDF in the job's Documents every time it is generated",
    ...
    pullSyncNow: "☁️ Sync Now",
    pullSyncPending: "☁️ Not Synced Yet",
    pullSyncPendingDesc: "AccuLynx is connected. This job has not been sent in this session. Sync status is not stored, so it resets when you reload.",
    ...
    pullReportNotFiledDesc: "Press PDF on this job to generate the report and upload it.",
    pullReportUploadOff: "Report upload is off. Turn it on in Settings → CRM Integration.",
  ...
  es: {
    ...
    stUploadReport: "Subir reporte a AccuLynx",
    stUploadReportDesc: "Archivar el PDF del reporte en Documentos del trabajo cada vez que se genera",
    ...
    pullSyncNow: "☁️ Sincronizar Ahora",
    pullSyncPending: "☁️ Aún No Sincronizado",
    pullSyncPendingDesc: "AccuLynx está conectado. Este trabajo no se ha enviado en esta sesión. El estado no se guarda, así que se reinicia al recargar.",
    ...
    pullReportNotFiledDesc: "Presione PDF en este trabajo para generar el reporte y subirlo.",
    pullReportUploadOff: "La carga de reportes está desactivada. Actívela en Configuración → Integración CRM.",
