...
export const translations = {
  en: {
    ...
    pullCloseJob: "Close",
    pullClosing: "Closing...",
    pullCloseConfirm: "Close this job? The report is filed. It will be archived out of active work and moved to the Closed list.",
    pullClosed: "Job closed and archived.",
    pullCloseFail: "Database Error: Could not close job.",
  ...
  es: {
    ...
    lgOr: "o",
    lgGoogle: "Iniciar sesión con Google",
    ...
    pullCloseJob: "Cerrar",
    pullClosing: "Cerrando...",
    pullCloseConfirm: "¿Cerrar este trabajo? El reporte ya está archivado. Se archivará fuera del trabajo activo y pasará a la lista de Cerrados.",
    pullClosed: "Trabajo cerrado y archivado.",
    pullCloseFail: "Error de Base de Datos: No se pudo cerrar el trabajo.",
