// src/shared/utils/translations.js
export const translations = {
  en: {
    ...
    ocBillingEmailPlaceholder: "billing@company.com",
    ocBillingCadence: "Billing cadence",
    ocMonthly: "Monthly",
    ocAnnual: "Annual",
    ...
    pullSyncUpload: "Sync Upload",
    pullAccuLynxUploadTitle: "AccuLynx Upload",
    pullUploadNow: "Upload Now",
    pullRetryUpload: "Retry Upload",
    pullUploadFailedBadge: "Upload Failed",
    ...
    pullHandoffSeeInBuild: "See it in Build Jobs",
    ...
    rptCostIncreasing: "Cost Increasing",
    ...
    rptElevatedWear: "Elevated Lifecycle Wear",
    ...
    rptAuditLoadFailTitle: "Couldn't load the audit history",
    ...
    bjCorrectReturnNoChange: "Nothing was changed.",
    colCurrentlyReturned: "Currently Returned",
    ...
    schLegendConflict: "booked and in the shop the same day",
    ...
    trAdminBlurb:
      "Upload your own clips and photos. Everyone in your company sees them here, under Steadwerk's own videos. Only your company's admins can add, edit or remove them.",
    trAdminTitleGlobal: "Steadwerk's training library",
    trAdminBlurbGlobal:
      "Upload clips and photos for every company to see. Only Steadwerk can add, edit or remove them.",
    ...
    trEdit: "Edit",
    trSaveChanges: "Save changes",
    trEditedOk: "Updated.",
    trEditFail: "Could not save that:",
    trTitleRequired: "Give the clip a title so people know what it covers.",
    trAddedBy: "Added by",
    trYourLibrary: "Training library",
    trainingDownload: "Download it instead.",
    trainingMoreComing:
      "More walkthroughs are on the way. Receiving stock, fleet inspections, and the maintenance board are next. If there is something you would rather see covered first, tell Sam and it moves up the list.",
    trainingFaqEyebrow: "Straight answers",
    trainingFaqHeading: "The questions people actually ask.",
    trFaqQ1: "What's the difference between Build Jobs, Pull Inventory, and Inventory?",
    trFaqA1Lead: "They cover three different moments.",
    trFaqA1Rest:
    ...
    trFaqA3Rest:
      "Anyone can submit a request when something's wrong with a truck. Whoever manages maintenance sees the queue and closes each one out once it's fixed.",
    trFaqQ4: "Why don't I see the same tabs as someone else at my company?",
    trFaqA4Lead: "The sidebar follows your role.",
    trFaqA4Rest:
      "What shows up depends on your permissions, so a warehouse or field role sees a different list than an admin. If something you need is missing, ask your company's admin to check your access.",
    trainingHelpIntro: "Question that's not here? Email",
    trainingHelpOr: "or call",
    trainingHelpOutro: "and a real person answers, not a bot.",
  ...
  es: {
    ...
    ocBillingEmailPlaceholder: "facturacion@empresa.com",
    ocBillingCadence: "Frecuencia de facturación",
    ocMonthly: "Mensual",
    ocAnnual: "Anual",
    ...
    // ── ADDED MISSING INVENTORY SPANISH STRINGS ──
    searchInventory: "Buscar materiales...",

    availableStock: "Stock Disponible",
    unit: "Unidad",
    status: "Estado",
    // ── ADDED MISSING FLEET & MAINTENANCE SPANISH STRINGS ──
    ...
    pullNew: "NUEVO",
    pullNoPoHash: "Sin PO #",
    pullSyncFailed: "Falló la Sincronización",
    ...
    pullSyncUpload: "Subir a AccuLynx",
    pullAccuLynxUploadTitle: "Carga a AccuLynx",
    pullUploadNow: "Subir Ahora",
    pullRetryUpload: "Reintentar Carga",
    pullUploadFailedBadge: "Falló la Carga",
    ...
    pullHandoffSeeInBuild: "Verlo en Crear Trabajos",
    ...
    rptCostIncreasing: "Costo en Aumento",
    ...
    rptElevatedWear: "Desgaste Elevado del Ciclo de Vida",
    ...
    rptAuditLoadFailTitle: "No se pudo cargar el historial de auditoría",
    ...
    bjCorrectReturnNoChange: "No se cambió nada.",
    colCurrentlyReturned: "Devuelto Actualmente",
    ...
    schLegendConflict: "reservado y en el taller el mismo día",
    ...
    trAdminBlurb:
      "Suba sus propios videos y fotos. Todos en su empresa los ven aquí, debajo de los videos de Steadwerk. Solo los administradores de su empresa pueden agregarlos, editarlos o quitarlos.",
    trAdminTitleGlobal: "Biblioteca de capacitación de Steadwerk",
    trAdminBlurbGlobal:
      "Suba videos y fotos para que los vean todas las empresas. Solo Steadwerk puede agregarlos, editarlos o quitarlos.",
    ...
    trEdit: "Editar",
    trSaveChanges: "Guardar cambios",
    trEditedOk: "Actualizado.",
    trEditFail: "No se pudo guardar:",
    trTitleRequired: "Dele un título al video para que la gente sepa qué cubre.",
    trAddedBy: "Agregado por",
    trYourLibrary: "Biblioteca de capacitación",
    trainingDownload: "Descárguelo en su lugar.",
    trainingMoreComing:
      "Vienen más guías en camino. Recepción de material, inspecciones de flota y el tablero de mantenimiento son las siguientes. Si prefiere que se cubra otro tema primero, dígaselo a Sam y subirá en la lista.",
    trainingFaqEyebrow: "Respuestas directas",
    trainingFaqHeading: "Las preguntas que la gente realmente hace.",
    trFaqQ1: "¿Cuál es la diferencia entre Programar Trabajos, Retirar Inventario e Inventario?",
    trFaqA1Lead: "Cubren tres momentos distintos.",
    trFaqA1Rest:
      "Programar Trabajos es donde se crea, se asigna personal y se cierra un trabajo. Retirar Inventario es donde una cuadrilla retira los materiales que necesita un trabajo específico. Inventario es la vista completa del stock — niveles, lotes y lo que se está agotando — en todo el almacén.",
    trFaqQ2: "¿Qué muestra la vista de Flota?",
    trFaqA2Lead: "Cada vehículo, en un solo lugar.",
    trFaqA2Rest:
      "Asignaciones, fechas de cambio de aceite y servicio, y qué camiones están fuera de servicio actualmente.",
    trFaqQ3: "¿Para qué sirve la pantalla de Mantenimiento?",
    trFaqA3Lead: "Reportar y dar seguimiento a problemas de los vehículos.",
    trFaqA3Rest:
      "Cualquiera puede enviar una solicitud cuando algo anda mal con un camión. Quien administra el mantenimiento ve la cola y cierra cada una una vez resuelta.",
    trFaqQ4: "¿Por qué no veo las mismas pestañas que otra persona de mi empresa?",
    trFaqA4Lead: "La barra lateral sigue su rol.",
    trFaqA4Rest:
      "Lo que aparece depende de sus permisos, así que un rol de almacén o campo ve una lista distinta a la de un administrador. Si falta algo que necesita, pídale al administrador de su empresa que revise su acceso.",
    trainingHelpIntro: "¿Su pregunta no está aquí? Escriba a",
    trainingHelpOr: "o llame al",
    trainingHelpOutro: "y una persona real responde, no un bot.",
