...
export const SEED_V = [
  { id: 'v1', name: 'Truck 001', type: 'truck', mi: 87500, lomi: 83200, oii: 5000, dii: 90, ldd: '2025-02-15', mil: [{ dt: '2025-05-14', mi: 87500, by: 'u1' }], sl: [{ id: 's1', type: 'Oil Change', dt: '2025-03-01', mi: 83200, by: 'Quick Lube', notes: '5W-30 Synthetic', cost: 89 }], plate: 'MRR-001', yr: 2020, make: 'Ford', model: 'F-250', assignedTo: 'u3' },
  { id: 'v2', name: 'Truck 002', type: 'truck', mi: 62300, lomi: 58900, oii: 5000, dii: 90, ldd: '2025-03-10', mil: [{ dt: '2025-05-14', mi: 62300, by: 'u2' }], sl: [], plate: 'MRR-002', yr: 2021, make: 'Ford', model: 'F-250', assignedTo: 'u7' },
  { id: 'v3', name: 'Truck 003', type: 'truck', mi: 112000, lomi: 108500, oii: 5000, dii: 90, ldd: '2025-01-20', mil: [], sl: [], plate: 'MRR-003', yr: 2019, make: 'Ram', model: '2500', assignedTo: '' },
  { id: 'v4', name: 'Truck 004', type: 'truck', mi: 45200, lomi: 43500, oii: 5000, dii: 90, ldd: '2025-04-01', mil: [], sl: [], plate: 'MRR-004', yr: 2022, make: 'Chevy', model: 'Silverado 2500', assignedTo: '' },
  { id: 'v5', name: 'Truck 005', type: 'truck', mi: 0, lomi: 0, oii: 5000, dii: 90, ldd: '2026-05-01', mil: [], sl: [], plate: 'MRR-005', yr: 2022, make: 'Ford', model: 'F-250', assignedTo: '' },
  { id: 'v6', name: 'Truck 006', type: 'truck', mi: 0, lomi: 0, oii: 5000, dii: 90, ldd: '2026-05-01', mil: [], sl: [], plate: 'MRR-006', yr: 2022, make: 'Ford', model: 'F-250', assignedTo: '' },
  { id: 'v7', name: 'Truck 007', type: 'truck', mi: 0, lomi: 0, oii: 5000, dii: 90, ldd: '2026-05-01', mil: [], sl: [], plate: 'MRR-007', yr: 2023, make: 'Ford', model: 'F-150', assignedTo: '' },
  { id: 'v8', name: 'Truck 008', type: 'truck', mi: 0, lomi: 0, oii: 5000, dii: 90, ldd: '2026-05-01', mil: [], sl: [], plate: 'MRR-008', yr: 2021, make: 'Ram', model: '1500', assignedTo: '' },
  { id: 'v9', name: 'Truck 009', type: 'truck', mi: 0, lomi: 0, oii: 5000, dii: 90, ldd: '2026-05-01', mil: [], sl: [], plate: 'MRR-009', yr: 2022, make: 'Chevy', model: 'Silverado', assignedTo: 'u3' },
  { id: 'v10', name: 'Truck 010', type: 'truck', mi: 0, lomi: 0, oii: 5000, dii: 90, ldd: '2026-05-01', mil: [], sl: [], plate: 'MRR-010', yr: 2022, make: 'Ford', model: 'F-250', assignedTo: '' },
  { id: 'v11', name: 'Truck 011', type: 'truck', mi: 0, lomi: 0, oii: 5000, dii: 90, ldd: '2026-05-01', mil: [], sl: [], plate: 'MRR-011', yr: 2023, make: 'Ford', model: 'F-250', assignedTo: '' },
  { id: 'v12', name: 'Truck 012 (Production Truck)', type: 'truck', mi: 0, lomi: 0, oii: 5000, dii: 90, ldd: '2026-05-01', mil: [], sl: [], plate: 'MRR-012', yr: 2022, make: 'GMC', model: 'Sierra 2500', assignedTo: '' },
  { id: 'v16', name: 'Truck 016 (Gold F250)', type: 'truck', mi: 0, lomi: 0, oii: 5000, dii: 90, ldd: '2026-05-01', mil: [], sl: [], plate: 'MRR-016', yr: 2021, make: 'Ford', model: 'F-250', assignedTo: 'u1' },
  { id: 'v17', name: 'Truck 017 (Blue F150)', type: 'truck', mi: 0, lomi: 0, oii: 5000, dii: 90, ldd: '2026-05-01', mil: [], sl: [], plate: 'MRR-017', yr: 2020, make: 'Ford', model: 'F-150', assignedTo: '' },
  { id: 'v18', name: 'Truck 018 (Box Truck)', type: 'truck', mi: 0, lomi: 0, oii: 5000, dii: 90, ldd: '2026-05-01', mil: [], sl: [], plate: 'MRR-018', yr: 2019, make: 'Isuzu', model: 'NPR', assignedTo: '' },
  { id: 'v13', name: 'Dump Trailer 013', type: 'trailer', mi: 0, lomi: 0, oii: 5000, dii: 90, ldd: '2025-03-01', mil: [], sl: [], plate: 'TRL-013', yr: 2022, make: 'PJ Trailers', model: 'Dump 14\'', assignedTo: '' },
  { id: 'v14', name: 'Dump Trailer 014', type: 'trailer', mi: 0, lomi: 0, oii: 5000, dii: 90, ldd: '2025-01-15', mil: [], sl: [], plate: 'TRL-014', yr: 2022, make: 'PJ Trailers', model: 'Dump 14\'', assignedTo: '' },
  { id: 'v15', name: 'Dump Trailer 015', type: 'trailer', mi: 0, lomi: 0, oii: 5000, dii: 90, ldd: '2026-05-01', mil: [], sl: [], plate: 'TRL-015', yr: 2023, make: 'Big Tex', model: 'Dump 14\'', assignedTo: '' },
  { id: 'v19', name: 'Equipter Buggy 019', type: 'trailer', mi: 0, lomi: 0, oii: 5000, dii: 180, ldd: '2026-05-01', mil: [], sl: [], plate: 'EQP-001', yr: 2022, make: 'Equipter', model: '4000', assignedTo: '' }
];
